 ...
 */
public class RecipeDecorationColumns extends RecyclerView.ItemDecoration {
    ...
    public RecipeDecorationColumns(int topSpacing, int bottomSpacing, int leftSpacing, int rightSpacing) {
